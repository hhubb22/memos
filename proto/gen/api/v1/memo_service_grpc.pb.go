...
func (c *memoServiceClient) GenerateInsight(ctx context.Context, in *GenerateInsightRequest, opts ...grpc.CallOption) (*GenerateInsightResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GenerateInsightResponse)
	err := c.cc.Invoke(ctx, MemoService_GenerateInsight_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _MemoService_GenerateInsight_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GenerateInsightRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MemoServiceServer).GenerateInsight(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MemoService_GenerateInsight_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MemoServiceServer).GenerateInsight(ctx, req.(*GenerateInsightRequest))
	}
	return interceptor(ctx, in, info, handler)
}
